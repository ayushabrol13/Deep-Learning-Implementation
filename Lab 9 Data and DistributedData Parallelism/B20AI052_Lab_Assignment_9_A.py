...
def get_dataflow(config):
    ...
    train_loader = idist.auto_dataloader(train_dataset, batch_size=config["batch_size1"], num_workers=config["num_workers"], shuffle=True)
...
print("Results for 1 GPU with 2 processes")
spawn_kwargs = {}
...
print("Training completed for 1 GPU with 1 process")
